<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ctrEmployee_Add.ascx.cs" Inherits="RCTemp.Controls_Add.ctrEmployee_Add" %>
...
<asp:TableRow>
 <asp:TableCell HorizontalAlign="Right" Font-Bold="false">Employee ID<span class="required">*</span>:</asp:TableCell>
  <asp:TableCell > 
