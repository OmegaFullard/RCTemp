<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ctrSearch_Employee_Find.ascx.cs" Inherits="RCTemp.Controls_Search.ctrSearch_Employee_Find" %>

<asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>

                       You can use a partial Inventory Name in your search
